...
class Stock:
    def __init__(self, stock_type, amount=0):
        if not isinstance(stock_type, str) or len(stock_type) == 0:
            raise ValueError("Stock type must be a string and cannot be empty.")
    ...
    def __add__(self, other):
        if isinstance(other, self.__class__):
            if self.type != other.type:
                raise ValueError(f"Stock types cannot be different during the addition of two {self.__class__} objects.")
    ...
    def __sub__(self, other):
        if isinstance(other, self.__class__):
            if self.type != other.type:
                raise ValueError(f"Stock types cannot be different during the subtraction of two {self.__class__} objects.")
            elif self < other:
    ...
    def __lt__(self, other):
        if isinstance(other, self.__class__):
            if self.type != other.type:
                raise ValueError(f"Stock types cannot be different while comparing two {self.__class__} objects.")
    ...
    def __eq__(self, other):
        if isinstance(other, self.__class__):
            ...
            raise TypeError(f"Equals operator for {self.__class__} can only support {self.__class__}, integer, or float.")
    
    def __le__(self, other):
        if isinstance(other, self.__class__) or isinstance(other, int) or isinstance(other, float):
            return self < other or self == other
        else:
            raise TypeError(f"Less than or equal to operator for {self.__class__} can only support {self.__class__}, integer, or float.")
    ...
    def __gt__(self, other):
        if isinstance(other, self.__class__):
            ...
            raise TypeError(f"Greater than operator for {self.__class__} can only support {self.__class__}, integer, or float.")
    
    def __ge__(self, other):
        if isinstance(other, self.__class__) or isinstance(other, int) or isinstance(other, float):
            return self > other or self == other
        else:
            raise TypeError(f"Greater than or equal to operator for {self.__class__} can only support {self.__class__}, integer, or float.")
